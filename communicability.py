...
def get_arguments(base_path = os.getcwd()):
    ...
    parser.add_argument('--ROI_num', type=int,default=400, choices=[180, 360, 400])
...
if args.ROI_num == 400:
    ...
    ROI_name = 'HCPMMP1'
elif args.ROI_num == 360:
    ROI_name = 'HCPMMP1_asymmetric'
...
def main(sub):
    if args.ROI_num == 400:
        ...
        path_to_fMRIs = os.path.join(data_dir, 'sub-'+sub, 'hcp_mmp1_sub-'+sub+'.npy')
    y = np.load(path_to_fMRIs)[:seq_len].T
